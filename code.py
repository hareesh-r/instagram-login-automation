...
def login():
    ...
    try:
        ...
        userID.send_keys(r'user_name_here')
        ...
        nextBtn = driver.find_element_by_xpath('//*[@id="loginForm"]/div[1]/div[3]/button')

        nextBtn.click()

        saveInfoBtn = driver.find_element_by_xpath('//*[@id="react-root"]/section/main/div/div/div/section/div/button')

        saveInfoBtn.click()

        notNowBtn = driver.find_element_by_xpath('/html/body/div[4]/div/div/div/div[3]/button[2]')
...
def search(name):
    ...
    clickSearchResult = driver.find_element_by_xpath('//*[@id="react-root"]/section/nav/div[2]/div/div/div[2]/div[4]/div/a[1]')
...
def openChat():
    ...
    messageBtn = driver.find_element_by_xpath('//*[@id="react-root"]/section/main/div/header/section/div[1]/div[1]/div/div[1]/div/button')
...
def sendMessage(messageList):
    ...
    messageBox = driver.find_element_by_xpath('//*[@id="react-root"]/section/div/div[2]/div/div/div[2]/div[2]/div/div[2]/div/div/div[2]/textarea')
    ...
    for i in messageList:
        ...
        if len(i)>7:
            ...
            sendButton = driver.find_element_by_xpath('//*[@id="react-root"]/section/div/div[2]/div/div/div[2]/div[2]/div/div[2]/div/div/div[3]/button') 

            sendButton.click()

            time.sleep(0.5)

            print(messageList.index(i),i,'sent successfully',sep=" ")
    
    print('closing tab')

login()

search(r'recipent_name_here')
